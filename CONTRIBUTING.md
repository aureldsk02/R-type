...
This document outlines the contribution guidelines for the R-Type project.  
Please follow these rules to contribute effectively!

**Project Maintainer:** Aurel DOSSOU KOHI  
**Contact:** aurel.dossou-kohi@epitech.eu
...
Refer to the COMMIT_CONVENTION.md at the root of the repository
